...
export function PortfolioHero() {
  ...
  return (
    <section
      id="work"
      className="relative mx-auto w-full max-w-6xl isolate overflow-hidden rounded-[36px] border border-hairline/50 bg-ink/70 px-6 py-24 shadow-[0_60px_120px_-80px_rgba(22,16,64,0.8)] backdrop-blur-xl sm:px-10 lg:px-16"
    >
